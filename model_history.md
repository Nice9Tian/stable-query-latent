...
- **slot8 终判**（2026-07-20，5/5 折）：non 配对 +0.016±0.030（3/5 胜，
  噪声带内），neutral −0.010（0/5）、tag −0.011/−0.013——容量假说在
  4096 亦不成立；结合 @512 网格平坦 ⇒ **槽容量在任何尺度都非瓶颈**，
  单层 4 槽塔为折级双尺度确证。mq3072i2ce 期中（3/5）：non −0.112、
  neu −0.031、tag +0.015/+0.019——MoCo 经济折级价签重于固定分割预估。
