...
other three = train; permutation seed 20260711).
    ...
    python sql_experiment/run_cv.py                      # 6 recipes x 5 folds
    python sql_experiment/run_cv.py --recipes ce --folds 0 1
"""
import argparse
import copy
import sys
...
from sql_experiment.contrast_models.roster import ARMS, CV_RECIPES
from sql_experiment.run_all import train_fn_for
